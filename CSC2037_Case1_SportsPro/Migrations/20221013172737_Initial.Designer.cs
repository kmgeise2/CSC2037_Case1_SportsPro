...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CSC2037_Case1_SportsPro.Models.Country", b =>
                {
            ...
            modelBuilder.Entity("CSC2037_Case1_SportsPro.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("CSC2037_Case1_SportsPro.Models.Incident", b =>
                {
            ...
            modelBuilder.Entity("CSC2037_Case1_SportsPro.Models.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CSC2037_Case1_SportsPro.Models.Technician", b =>
                {
                    b.Property<int>("TechnicianID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CSC2037_Case1_SportsPro.Models.Customer", b =>
                {
                    b.HasOne("CSC2037_Case1_SportsPro.Models.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("CSC2037_Case1_SportsPro.Models.Incident", b =>
                {
                    b.HasOne("CSC2037_Case1_SportsPro.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSC2037_Case1_SportsPro.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSC2037_Case1_SportsPro.Models.Technician", "Technician")
                        .WithMany()
